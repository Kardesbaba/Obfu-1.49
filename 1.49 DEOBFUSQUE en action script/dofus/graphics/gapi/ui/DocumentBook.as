class dofus.graphics.gapi.ui.DocumentBook extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function over(oEvent)
   {
      ...
      {
         case "_btnPrevious":
            this.gapi.showTooltip(this.api.lang.getText("PREVIOUS_PAGE"));
            return;
         case "_btnNext":
            this.gapi.showTooltip(this.api.lang.getText("NEXT_PAGE"));
            return;
         default:
            this.gapi.showTooltip(this.api.lang.getText("CHOOSE_PAGE_NUMBER"));
            return;
      }
   }
   function out(oEvent)
