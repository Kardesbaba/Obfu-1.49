class dofus.graphics.gapi.ui.ChooseServer extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function set servers(aCellList)
   {
      this._eaServers = aCellList;
   }
   ...
   function initTexts()
   {
      ...
      {
         this._lblLogin.text = this.api.datacenter.Basics.dofusPseudo + (!this.api.datacenter.Basics.isCoLimited ? "" : " (Co limited)");
      }
      else
      {
