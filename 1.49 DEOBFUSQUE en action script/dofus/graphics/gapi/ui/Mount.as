class dofus.graphics.gapi.ui.Mount extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function editName(aCellList)
   {
      this._tiName._visible = aCellList;
      this._btnNameValid._visible = aCellList;
      this._mcTextInputBackground._visible = aCellList;
      this._lblNameValue._visible = !aCellList;
      this._btnName._visible = !aCellList;
   }
   ...
   function over(oEvent)
   {
      ...
      {
         case this._btnName:
            this.gapi.showTooltip(this.api.lang.getText("MOUNT_RENAME_TOOLTIP"));
            break;
         case this._btnInventory:
            this.gapi.showTooltip(this.api.lang.getText("MOUNT_INVENTORY_ACCES"));
            break;
         case this._btnRide:
            this.gapi.showTooltip(this.api.lang.getText("MOUNT_RIDE_TOOLTIP"));
            break;
         case this._btnAction:
            this.gapi.showTooltip(this.api.lang.getText("MOUNT_ACTION_TOOLTIP"));
            break;
         case this._btnXP:
            this.gapi.showTooltip(this.api.lang.getText("MOUNT_XP_PERCENT_TOOLTIP"));
         default:
            return;
      }
   }
