class dofus.graphics.gapi.ui.PopupText extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function set useAllStage(aColors)
   {
      this._bUseAllStage = aColors;
   }
   function set maxChars(oSpell)
   {
      this._nMaxChars = oSpell;
   }
   function set restrict(aCellList)
   {
      this._sRestrict = aCellList;
   }
   function get value()
   {
      return this._sValue;
