class dofus.graphics.gapi.ui.PlayerShopModifier extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function hideItemViewer(bHide)
   {
      ...
      this._tiQuantity._visible = !bHide;
   ...
   function setAddMode(bActive)
   {
      ...
      this._tiQuantity.enabled = true;
      this._tiPrice.tabIndex = 0;
      this._tiQuantity.tabIndex = 1;
   ...
   function setModifyMode(bActive)
   {
      ...
      this._tiQuantity.enabled = false;
      this._tiPrice.tabIndex = 0;
      this._tiQuantity.tabIndex = undefined;
   ...
   function click(oEvent)
   {
      ...
      switch(oEvent.target)
      {
         ...
         case this._btnAdd:
            ...
            _loc6_ = _global.parseInt(this._tiQuantity.text,10);
      ...
      else
      {
         ...
         switch(oEvent.target)
         {
            case this._livInventory:
               this._tiQuantity.text = oEvent.item.Quantity;
               this._tiPrice.text = "";
               this.setModifyMode(false);
