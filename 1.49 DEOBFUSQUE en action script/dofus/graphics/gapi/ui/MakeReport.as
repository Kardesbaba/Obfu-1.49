class dofus.graphics.gapi.ui.MakeReport extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function set targetPseudos(aColors)
   {
      this._sTargetPseudos = aColors;
   }
   ...
   function set jailDialog(aCellList)
   {
      this._sJailDialog = aCellList;
   }
   function get penal()
   {
      return this._sPenal;
   }
   function set penal(sComplementary)
   {
      this._sPenal = sComplementary;
   }
   function get findAccounts()
   {
      return this._sFindAccounts;
   }
   function set findAccounts(sJailDialog)
   {
      this._sFindAccounts = sJailDialog;
   }
   function get reason()
   {
      return this._sReason;
   }
   function set reason(penal)
   {
      this._sReason = penal;
   }
   function init()
