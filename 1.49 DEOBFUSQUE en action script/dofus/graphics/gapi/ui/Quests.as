class dofus.graphics.gapi.ui.Quests extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function updateDaylies()
   {
      this._uiDailyQuests.updateData();
   }
   function init()
   {
   ...
   function showStepViewer(bShow)
   {
      ...
      this._mcTabPlacer._visible = bShow;
      this._uiDailyQuests._visible = !bShow;
   }
   ...
   function click(oEvent)
   {
      switch(oEvent.target._name)
      {
         ...
         case "_btnCloseStep":
            ...
            this.api.datacenter.Basics.quests_lastID = -1;
            this.showStepViewer(false);
         default:
            return;
      }
