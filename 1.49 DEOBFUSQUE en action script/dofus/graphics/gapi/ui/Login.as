class dofus.graphics.gapi.ui.Login extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function set canAutoLogOn(sLogin)
   {
      this._bCanAutoLogOn = sLogin;
   }
   ...
   function initInput()
   {
      ...
      var _loc2_ = false;
      var _loc3_;
      if(dofus.Constants.DEBUG || _global.CONFIG.isExpo)
      {
         this._tiAccount.restrict = "\\-a-zA-Z0-9|@+._[]";
         this._tiAccount.maxChars = 50;
         _loc3_ = _global.CONFIG.autoLogin;
         if(_loc3_ == undefined)
         {
            _loc3_ = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME).data.loginInfos;
         }
         if(_loc3_ != undefined)
         {
   ...
   function onLogin(sLogin,sPassword,bZaapConnect)
   {
      ...
      if(!bZaapConnect)
      {
         ...
         {
            _loc5_ = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
   ...
   function close(oEvent)
   {
      ...
      var _loc3_ = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
   ...
   function click(oEvent)
   {
      ...
      switch(oEvent.target._name)
      {
         ...
         case "_btnServersState":
            _loc6_ = ank.utils.SharedObjectFix.getLocal(dofus.Constants.OPTIONS_SHAREDOBJECT_NAME);
   ...
   function over(oEvent)
   {
      ...
      {
         case "_mcPurple":
            this.gapi.showTooltip(this.api.lang.getText("PURPLE_DOFUS"));
            return;
         case "_mcEmerald":
            this.gapi.showTooltip(this.api.lang.getText("EMERALD_DOFUS"));
            return;
         case "_mcTurquoise":
            this.gapi.showTooltip(this.api.lang.getText("TURQUOISE_DOFUS"));
            return;
         case "_mcEbony":
            this.gapi.showTooltip(this.api.lang.getText("EBONY_DOFUS"));
            return;
         case "_mcIvory":
            this.gapi.showTooltip(this.api.lang.getText("IVORY_DOFUS"));
            return;
         case "_mcOchre":
            this.gapi.showTooltip(this.api.lang.getText("OCHRE_DOFUS"));
            return;
         case "_mcInfoAccount":
            this.gapi.showTooltip(this.api.lang.getText("LOGIN_USERNAME_TOOLTIP"));
            return;
         default:
            if(String(oEvent.target._name).substring(0,7) == "_mcFlag")
            {
            ...
            this.gapi.showTooltip(oEvent.target.params.description);
            return;
      }
   }
   function out(oEvent)
