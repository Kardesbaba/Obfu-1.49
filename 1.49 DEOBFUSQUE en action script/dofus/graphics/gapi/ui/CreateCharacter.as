class dofus.graphics.gapi.ui.CreateCharacter extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function setClass(nClassID,nSex)
   {
      ...
      if(this.api.datacenter.Basics.aks_current_server.isTemporis())
      {
         this._lblTitlePassiveTemporis.text = _loc7_.pt;
         this._txtPassiveTemporis.text = _loc7_.pd;
      }
      ...
      this._nSex = nSex;
      this.api.ui.getUIComponent("HistoryViewerOnCreate").breed = nClassID;
      this.api.ui.getUIComponent("SpellViewerOnCreate").breed = nClassID;
   }
   ...
   function over(oEvent)
   {
      switch(oEvent.target)
      {
         case this._csColors:
            ...
            break;
         case this._mcRandomName:
            this.gapi.showTooltip(this.api.lang.getText("RANDOM_NICKNAME"));
            break;
         case this._mcMaleButton:
            this.gapi.showTooltip(this.api.lang.getText("ANIMAL_MEN"));
            break;
         case this._mcFemaleButton:
            this.gapi.showTooltip(this.api.lang.getText("ANIMAL_WOMEN"));
            break;
         case this._mcSpellButton:
            this.gapi.showTooltip(this.api.lang.getText("CLASS_SPELLS"));
            break;
         case this._mcRight:
            this.gapi.showTooltip(this.api.lang.getText("NEXT_WORD"));
            break;
         case this._mcLeft:
            this.gapi.showTooltip(this.api.lang.getText("PREVIOUS_WORD"));
         default:
            return;
      }
   }
   ...
   function onMouseWheel(aCellList,mc)
   {
      ...
      {
         this._csBreedSelection.slide(aCellList <= 0 ? 1 : -1);
      }
   }
