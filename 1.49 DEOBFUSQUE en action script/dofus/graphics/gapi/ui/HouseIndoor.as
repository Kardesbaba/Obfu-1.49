class dofus.graphics.gapi.ui.HouseIndoor extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function set house(Accessory)
   {
      this._hHouse = Accessory;
      this.api.gfx.addEventListener("mapLoaded",this);
      Accessory.addEventListener("forsale",this);
      Accessory.addEventListener("locked",this);
      this._mcForSale._visible = Accessory.isForSale;
      this._mcLock._visible = Accessory.isLocked;
   }
