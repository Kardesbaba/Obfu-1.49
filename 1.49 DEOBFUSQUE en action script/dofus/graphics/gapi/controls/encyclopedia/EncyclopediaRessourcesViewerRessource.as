class dofus.graphics.gapi.controls.encyclopedia.EncyclopediaRessourcesViewerRessource extends ank.gapi.core.UIBasicComponent
{
   var addToQueue;
   var _ctrIcon;
   var _lblCategory;
   ...
   function EncyclopediaRessourcesViewerRessource()
   {
      super();
   }
