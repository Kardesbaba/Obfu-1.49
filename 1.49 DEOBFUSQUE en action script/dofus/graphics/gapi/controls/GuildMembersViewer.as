class dofus.graphics.gapi.controls.GuildMembersViewer extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function initTexts()
   {
      this._dgMembers.columnsNames = ["","",this.api.lang.getText("NAME_BIG"),this.api.lang.getText("GUILD_RANK"),this.api.lang.getText("LEVEL_SMALL"),this.api.lang.getText("ACHIEVEMENT_SHORT"),this.api.lang.getText("PERCENT_XP"),this.api.lang.getText("WIN_XP"),""];
   ...
   function updateData(aCellList)
   {
      var _loc3_ = 0;
      var _loc4_ = 0;
      while(_loc4_ < aCellList.length)
      {
         if(aCellList[_loc4_].state != 0)
         {
            _loc3_ = _loc3_ + 1;
         }
         _loc4_ = _loc4_ + 1;
      }
      this._lblCount.text = _loc3_ + " / " + String(aCellList.length) + " " + ank.utils.PatternDecoder.combine(this.api.lang.getText("MEMBERS"),"m",aCellList.length < 2);
      var _loc5_ = new ank.utils.ExtendedArray();
      var _loc6_;
      if(!this._btnShowOfflineMembers.selected)
      {
         _loc6_ = 0;
         while(_loc6_ < aCellList.length)
         {
            if(aCellList[_loc6_].state != 0)
            {
               _loc5_.push(aCellList[_loc6_]);
            }
            _loc6_ = _loc6_ + 1;
         }
      }
      ...
      var _loc7_ = 0;
      var _loc8_ = 0;
      while(_loc8_ < aCellList.length)
      {
         _loc7_ += aCellList[_loc8_].level;
         _loc8_ = _loc8_ + 1;
      }
      _loc7_ = Math.floor(_loc7_ / aCellList.length);
