   ...
   function over(event)
   {
      ...
      switch(event.target)
      {
         case this._mcGotAreasInteractivity:
            this.api.ui.showTooltip(this.api.lang.getText("CONQUEST_GOT_ZONES",[_loc3_.ownedAreas,_loc3_.possibleAreas,_loc3_.ownedVillages,_loc3_.totalAreas]));
            break;
         case this._mcGotVillagesInteractivity:
            this.api.ui.showTooltip(this.api.lang.getText("CONQUEST_GOT_VILLAGES",[_loc3_.ownedVillages,_loc3_.totalVillages]));
         default:
            return;
      }
   }
