class dofus.graphics.gapi.controls.JobOptionsViewer extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   {
      this.ressourcesNeeded.text = this.api.lang.getText("PUBLIC_MODE") + " (" + this.api.lang.getText(!this.api.datacenter.Player.craftPublicMode ? "INACTIVE" : "ACTIVE") + ")";
