class dofus.graphics.gapi.controls.AlignmentViewer extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function alignmentChanged(oEvent)
   {
      ...
      if(this.api.datacenter.Player.alignment.index != 0)
      {
         ...
         {
            this._parent.gapi.showTooltip(new ank.utils.ExtendedString(oEvent.alignment.value).addMiddleChar(this._parent.api.lang.getConfigText("THOUSAND_SEPARATOR"),3) + " / " + new ank.utils.ExtendedString(this._parent._pbAlignment.maximum).addMiddleChar(this._parent.api.lang.getConfigText("THOUSAND_SEPARATOR"),3));
         };
