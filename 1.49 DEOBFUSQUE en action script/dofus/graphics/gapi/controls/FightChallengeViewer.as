class dofus.graphics.gapi.controls.FightChallengeViewer extends ank.gapi.core.UIAdvancedComponent
{
   ...
   function initText()
   {
      ...
      this.n.text = "+" + (Number(this.challenge.teamDropBonus) + Number(this.challenge.basicDropBonus)) + "%";
   ...
   function addListeners()
   {
      ...
      this.n.onRollOver = this.virtualEvent(this,"over",this.n);
      this.n.onRollOut = this.virtualEvent(this,"out",this.n);
