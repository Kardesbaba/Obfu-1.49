   ...
   function over(oEvent)
   {
      ...
      switch(oEvent.target)
      {
         ...
         case this._btnColor3:
            ...
            break;
         case this._btnReset:
            this.gapi.showTooltip(this.api.lang.getText("REINIT_WORD"));
            break;
         case this._mcRandomColor1:
         case this._mcRandomColor2:
         case this._mcRandomColor3:
            this.gapi.showTooltip(this.api.lang.getText("RANDOM_COLOR"));
            break;
         case this._mcRandomAll:
            this.gapi.showTooltip(this.api.lang.getText("RANDOM_ALL_COLORS"));
         default:
            return;
      }
   }
