class dofus.graphics.gapi.controls.ChooseCharacterSprite extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   {
      super();
      this._nCurrAlpha = dofus.graphics.gapi.controls.ChooseCharacterSprite.DEATH_ALPHA;
   }
   function set showComboBox(bIsDead)
   {
      this._bShowComboBox = bIsDead;
   }
   ...
   function createChildren()
   {
      ...
      this._ldrRoundXP._visible = false;
   }
   function addListeners()
   {
      ...
      this._ldrRoundXP.addEventListener("over",this);
      this._ldrRoundXP.addEventListener("out",this);
   ...
   function updateData()
   {
      if(this._oData != undefined)
      {
         ...
         if(this._oData.xpMultiplicator > 1)
         {
            this._ldrXP._visible = true;
            this._ldrXP.contentPath = "BonusXPx" + this._oData.xpMultiplicator;
            this._ldrRoundXP._visible = true;
            this._ldrRoundXP.contentPath = "BonusXPx" + this._oData.xpMultiplicator + "_Round";
         }
         else
         {
            this._ldrXP._visible = false;
   ...
   function over(oEvent)
   {
      ...
      {
         case this._btnDelete:
            this.gapi.showTooltip(this.api.lang.getText("DELETE_CHARACTER"));
            break;
         case this._btnReset:
            this.gapi.showTooltip(this.api.lang.getText("RESET_CHARACTER"));
            break;
         case this._ctrServerState:
            this.gapi.showTooltip(this._oServer.stateStr);
            break;
         case this._ldrXP:
         case this._ldrRoundXP:
            this.gapi.showTooltip(this.api.lang.getText("EXPERIENCE_POINT_MULTIPLICATOR",[this._oData.xpMultiplicator]) + "\n\n" + this.api.lang.getText("CHARACTER_XP_BONUS_TOOLTIP"));
         default:
            return;
      }
   }
