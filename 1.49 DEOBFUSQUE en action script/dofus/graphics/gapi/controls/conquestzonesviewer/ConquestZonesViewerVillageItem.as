   ...
   function over(event)
   {
      switch(event.target)
      {
         ...
         case this._mcDoorInteractivity:
            this.api.ui.showTooltip(!this._oItem.door ? this.api.lang.getText("CONQUEST_VILLAGE_DOOR_CLOSE") : this.api.lang.getText("CONQUEST_VILLAGE_DOOR_OPEN"));
            break;
         case this._mcPrismInteractivity:
            this.api.ui.showTooltip(!this._oItem.prism ? this.api.lang.getText("CONQUEST_VILLAGE_PRISM_CLOSE") : this.api.lang.getText("CONQUEST_VILLAGE_PRISM_OPEN"));
         default:
            return;
      }
   }
