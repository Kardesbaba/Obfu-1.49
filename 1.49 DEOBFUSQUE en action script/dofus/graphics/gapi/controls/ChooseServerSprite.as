class dofus.graphics.gapi.controls.ChooseServerSprite extends dofus.graphics.gapi.core.DofusAdvancedComponent
{
   ...
   function updateData()
   {
      ...
      if(_loc2_ != undefined)
      {
         ...
         this._ldrSprite.contentPath = dofus.Constants.SERVER_SYMBOL_PATH + _loc2_.iconID + ".swf";
         if(_loc2_.isSeasonal())
         {
            this._ldrOverIcon.contentPath = "SeasonTitle_" + this.api.config.language;
         }
         else
         {
            this._ldrOverIcon.contentPath = "";
         }
   ...
   function over(oEvent)
   {
      ...
      {
         this.gapi.showTooltip(this.server.stateStr);
      }
   }
   function out(oEvent)
   {
