class dofus.sounds.AudioManager extends dofus.utils.ApiElement
{
   ...
   var _nCurrentSoundIndex;
   var _nCurrentMusicIndex;
   ...
   function getNextSoundIndex(Void)
   {
      ...
      var _loc3_ = "SND" + this._nCurrentSoundIndex;
      delete this._aSoundsCollection[_loc3_];
   ...
   function getNextMusicIndex(Void)
   {
      ...
      var _loc3_ = this._aSoundsCollection["SND" + this._nCurrentMusicIndex];
      _loc3_.dispose();
