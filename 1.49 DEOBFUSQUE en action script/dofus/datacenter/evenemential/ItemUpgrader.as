class dofus.datacenter.evenemential.ItemUpgrader
{
   ...
   {
      this.aTierLabels = ["I","II","III","IV","V","VI","VII"];
      this.aTierFragments = [20066,20067,20068,20069,20070,20071,20072];
      this.aTierRelics = [20073,20074,20075,20076,20077,20078,20079,20080];
      this._api = oApi;
      this._view = oView;
