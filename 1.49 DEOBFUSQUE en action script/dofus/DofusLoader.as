class dofus.DofusLoader extends ank.utils.QueueEmbedMovieClip
{
   ...
   {
      this._lblConnexionServer.text = this.getText("CONNECTION_SERVER");
   ...
   function log(sText,aCellList,aCellList_2)
   {
      ...
      this._currentLogger.log(sText,aCellList,aCellList);
   ...
   {
      this._lblLauncher._visible = bShow;
      this._lstLauncher._visible = bShow;
      this._lblConnexionServer._visible = bShow;
      this._lstConnexionServer._visible = bShow;
      this._lblPorts._visible = bShow;
      this._lstPorts._visible = bShow;
      this._lblClientData._visible = bShow;
      this._lstClientData._visible = bShow;
      this._btnChoose._visible = bShow;
      this._mcConfigBg._visible = bShow;
      this._btnShowId._visible = bShow;
      this._btnLogRequests._visible = bShow;
      this._btnDebugRequests._visible = bShow;
      this._btnOpenRetroChat._visible = bShow;
      this._btnOpenRetroConsole._visible = bShow;
      this._lblShowId._visible = bShow;
      this._lblLogRequests._visible = bShow;
      this._lblDebugRequests._visible = bShow;
      this._lblOpenRetroChat._visible = bShow;
      this._lblOpenRetroConsole._visible = bShow;
      this._lblShowCellIds._visible = bShow;
      this._lblSkipFightAnim._visible = bShow;
      this._btnSkipFightAnim._visible = bShow;
      this._btnShowCellIds._visible = bShow;
   }
   ...
   function chooseConfiguration(oConfLauncher,oConnServer,oConf,oLangUrl,bLog)
   {
      this.showConfigurationChoice(false);
      if(bLog)
      {
      ...
      _global.CONFIG.connexionServer = oConnServer != undefined ? {ip:oConnServer.url,port:oConf} : undefined;
