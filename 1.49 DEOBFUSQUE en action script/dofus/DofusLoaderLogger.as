class dofus.DofusLoaderLogger
{
   ...
   function initTexts()
   {
      ...
      this.LANG_TEXT.CONNECTION_SERVER = {fr:"Serveur de connexion",en:"Connection Server",es:"Servidor de conexión",de:"Verbindungsserver",pt:"Servidor de conexão",nl:"Verbindingsserver",it:"Server di connessione"};
      this.LANG_TEXT.CONFIGURATION_LAUNCHER = {fr:"Launcher",en:"Launcher",es:"Launcher",de:"Launcher",pt:"Launcher",nl:"Launcher",it:"Launcher"};
      this.LANG_TEXT.SERVER_PORT = {fr:"Port",en:"Port",es:"Port",de:"Port",pt:"Port",nl:"Port",it:"Port"};
      this.LANG_TEXT.SOURCE_LANG = {fr:"Données client",en:"Données client",es:"Données client",de:"Données client",pt:"Données client",nl:"Données client",it:"Données client"};
      this.LANG_TEXT.SHOW_ID = {fr:"Afficher les IDs (mode Debug)",en:"",es:"",de:"",pt:"",nl:"",it:""};
      this.LANG_TEXT.LOG_REQUESTS = {fr:"Log les paquets dans le dossier RetroLogs",en:"",es:"",de:"",pt:"",nl:"",it:""};
      this.LANG_TEXT.DEBUG_REQUESTS = {fr:"Log les paquets dans la console electron",en:"",es:"",de:"",pt:"",nl:"",it:""};
      this.LANG_TEXT.OPEN_EXTERN_CHAT = {fr:"Ouvrir une fenetre chat externe",en:"",es:"",de:"",pt:"",nl:"",it:""};
      this.LANG_TEXT.OPEN_EXTERN_CONSOLE = {fr:"Ouvrir une fenetre console externe",en:"",es:"",de:"",pt:"",nl:"",it:""};
      this.LANG_TEXT.SKIP_FIGHT_ANIM = {fr:"Passer les animations en combat",en:"",es:"",de:"",pt:"",nl:"",it:""};
      this.LANG_TEXT.SHOW_CELL_IDS = {fr:"Afficher les IDs de cellule",en:"",es:"",de:"",pt:"",nl:"",it:""};
      this.ERRORS = {};
      var _loc2_ = {};
