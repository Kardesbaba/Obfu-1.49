class dofus.managers.UIdManager
{
   ...
   function makeServer()
   {
      ...
      {
         var _loc3_ = ank.utils.SharedObjectFix.getLocal(dofus.Constants.GLOBAL_SO_IDENTITY_NAME);
   ...
   function makeClient()
   {
      ...
      this.receiving_lc.setUId = function(Account)
      {
         var _loc3_ = ank.utils.SharedObjectFix.getLocal(dofus.Constants.GLOBAL_SO_IDENTITY_NAME);
         _loc3_.data.identity = Account;
         _loc3_.close();
