class dofus.utils.nameChecker.rules.NameCheckerCharacterNameRules extends dofus.utils.ApiElement implements dofus.utils.nameChecker.rules.INameCheckerRules
{
   ...
   {
      super();
      this.NO_DASHES_ON_INDEXES = [0,1];
      this.UPPERCASE_ALLOWED_AFTER = ["-"];
      this.PROHIBED_WORDS_INSIDE = ["XELOR","IOP","FECA","ENIRIPSA","SADIDA","ECAFLIP","ENUTROF","PANDAWA","SRAM","CRA","OSAMODAS","SACRIEUR","DROP","MULE"];
   }
