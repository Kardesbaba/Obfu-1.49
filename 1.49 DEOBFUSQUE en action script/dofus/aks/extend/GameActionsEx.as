   ...
   function onActionEx(sExtraData,nActionType,sSenderID,oSeq,sParams,oContext)
   {
      ...
      switch(nActionType)
      {
         ...
         case 300:
            ...
            {
               _loc71_ = !_loc65_.bInCreaturesMode ? (!_global.isNaN(Number(_loc64_[5])) ? "anim" + _loc64_[5] : String(_loc64_[5]).split("~")) : "anim1";
            }
            _loc72_ = false;
         ...
         case 303:
            ...
            _loc88_ = _loc87_.mc;
            _loc89_ = !_loc87_.bInCreaturesMode ? _loc87_.ToolAnimation : "anim1";
