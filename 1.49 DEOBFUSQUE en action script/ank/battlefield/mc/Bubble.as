class ank.battlefield.mc.Bubble extends MovieClip
{
   ...
   function drawBackground(ack,_xmouse)
   {
      ...
      this._bg.lineTo(ack + _loc4_,- ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.lineTo(ack + _loc4_,- _xmouse - _loc4_ - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.lineTo(0,- _xmouse - _loc4_ - ank.battlefield.Constants.BUBBLE_PIC_HEIGHT);
      this._bg.endFill();
   }
