class ank.gapi.Gapi extends ank.utils.QueueEmbedMovieClip
{
   ...
   function get lastOpenedComponent()
   {
      var _loc2_ = this._eaUIComponentsInstances.length - 1;
      return this.getUIComponent(this._eaUIComponentsInstances[_loc2_].name);
   }
   function clear()
   {
   ...
   function showTooltip(sText,sStyleName)
   {
      if(sText == undefined)
      {
         return undefined;
      ...
      {
         _loc4_ = this._mcLayer_Popup._mcToolTip;
         _loc4_.text = sText;
      }
      else
      {
         this._mcLayer_Popup.attachMovie("ToolTip","_mcToolTip",this._mcLayer_Popup.getNextHighestDepth(),{text:sText,gapi:this,styleName:sStyleName});
      }
   }
   ...
   function setCursor(oData,oComponentParams,oUIParams)
   {
      if(oUIParams == undefined)
      {
         oUIParams = false;
      }
      ...
      oComponentParams.width = oComponentParams.width == undefined ? ank.gapi.Gapi.CURSOR_MAX_SIZE : oComponentParams.width;
      oComponentParams.height = oComponentParams.height == undefined ? ank.gapi.Gapi.CURSOR_MAX_SIZE : oComponentParams.height;
      oComponentParams.x = oComponentParams.x == undefined ? ank.gapi.Gapi.CURSOR_CENTER[0] : oComponentParams.x;
      oComponentParams.y = oComponentParams.y == undefined ? ank.gapi.Gapi.CURSOR_CENTER[1] : oComponentParams.y;
      ...
      _loc5_.setSize(oComponentParams.width,oComponentParams.height);
      _loc5_.move(oComponentParams.x,oComponentParams.y);
      _loc5_.contentData = oData;
      this._oCursorAligment = oComponentParams;
   ...
   function loadUIComponent(sLink,sInstanceName,oComponentParams,oUIParams)
   {
      ...
      if(oUIParams.nHideSprites != undefined && (this.api.kernel.OptionsManager.getOption("HideSpritesUIFullscreen") && this._sComponentHiddingSprites == undefined))
      {
